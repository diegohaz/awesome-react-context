...
<a href="https://github.com/diegohaz/constate">constate</a> is a ~2kB state management library that lets you write local state with ease and scale up to global state when needed using React Context.</p>
<br><br>
